...
def fitfwhm(xprofile, yprofile, zprofile, im, centres, window, options):
    xfit, yfit, zfit = [], [], [] 
    x_r2, y_r2, z_r2 = [], [], []
...
def plotfwhm(xfit, yfit, zfit, x, y, z, xprof, yprof, zprof, x_r2, y_r2, z_r2, index): # plots fits and profiles in x, y, and z
...
def everything(im, window, options, samplename="", save=False): # a function that does the whole sampling and fitting by collating the previous functions
    ...
    xfit, yfit, zfit, x, y, z, xprof, yprof, zprof, x_r2, y_r2, z_r2 = fitfwhm(xprof, yprof, zprof, im, centres, window, options)
